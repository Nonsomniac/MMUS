...
const int MMUS_ID = 39;  // valid from 0 to 999, but do not put leading 0 (compiler autoconverts to octal) {3 digits per filename space}, must be numeric between 1 and 120 for Rtivity compatibility,
const char versionNum[] = "3.0a";  // reserved to FOUR CHARACTERS.  This documents any code revisions

// Written by patrick richardson at Appalachian State University
